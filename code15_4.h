/* ************************************************************************
> File Name:     code15_4.cpp
> Author:        程序员Boy
> 微信公众号:    
> Created Time:  2023年08月28日 星期一 15时04分16秒
> Description:   http连接类
 ************************************************************************/
...
{
public:
    /*所socket上的事件被注册到同一epoll内核事件表上 所以将epoll文件描述符
     * 设置为静态的*/
...
public:
    ...
    /*http的请求方法 我们仅支持get*/
    enum METHOD {
        GET = 0,POST,HEAD,PUT,DELETE,TRACE,OPTIONS,CONTENT,PATCH
    };
    /*解析客户请求时 主状态机所处的状态（回忆第八张）*/
    enum CHECK_STATE {
